...
export class AuctionController {
  constructor(private useCase: AuctionUseCase) {}
  ...
  create(
    ...
    const result = this.useCase.create({ title, endTime });
  ...
  placeBid(
    ...
    const result = this.useCase.placeBid({ username, auctionId, value });
  ...
  getById(
    ...
    const auctionId = req.params.id;
    const result = this.useCase.getById(auctionId);
